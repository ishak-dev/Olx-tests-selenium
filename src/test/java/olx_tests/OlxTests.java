...
class OlxTests {
	...
	void testArticle() throws InterruptedException {
		...
		List<WebElement> articleList = wait
				.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.className("artikal")));
		...
		WebElement articleWindow = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"modal\"]")));
		...
		// gallery
		WebElement openGalleryBtn = webDriver
				.findElement(By.xpath("/html/body/div[4]/div[3]/div[1]/div[1]/div[1]/div/div[1]/ul/li[3]"));
		openGalleryBtn.click();
		Thread.sleep(1000);

		// list next
		for (int i = 0; i < 5; i++) {
			WebElement listNextBtn = wait
					.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[9]/div/div/div[2]/a[2]")));
			listNextBtn.click();
			Thread.sleep(1000);
		}
	...
	void chatTest() throws InterruptedException {
		...
		List<WebElement> messages = wait
				.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.className("tekst_poruke")));
	...
	void filterTest() throws InterruptedException {
		...
		String resNum2 = wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"pretraga-json\"]/div[2]/span")))
				.getText();
	...
	void postArticle() throws InterruptedException {
		...
		Thread.sleep(2000);
		webDriver.manage().timeouts().implicitlyWait(Duration.ofSeconds(2));
		webDriver.findElement(By.xpath("//*[@id=\"textareaKoristeno\"]"))
				.sendKeys("ovo je test verzija, slika je dobra");
		js.executeScript("window.scrollBy(0,900)");
	...
	void updateItem() throws InterruptedException {
		...
		String link_to_first_item = webDriver.findElement(By.className("listitem")).findElement(By.tagName("a"))
				.getAttribute("href");
		webDriver.findElement(By.className("listitem")).findElement(By.tagName("p")).click();

		assertEquals(link_to_first_item, webDriver.getCurrentUrl());

		js = (JavascriptExecutor) webDriver;
		js.executeScript("window.scrollBy(0,200)", "");
		Thread.sleep(500);

		WebElement element = webDriver.findElement(By.xpath("/html/body/div[4]/div[3]/div[2]/div[2]/div[4]/a[1]"));
		Actions actions = new Actions(webDriver);
		actions.moveToElement(element);
		actions.perform();
		webDriver.findElement(By.xpath("/html/body/div[4]/div[3]/div[2]/div[2]/div[4]/a[1]")).click();

		webDriver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div[2]/div[2]/div[1]/div/input")).clear();
		webDriver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div[2]/div[2]/div[1]/div/input"))
				.sendKeys("Naslov");
		webDriver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div[2]/div[2]/div[2]/p[2]/input")).clear();
		webDriver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div[2]/div[2]/div[2]/p[2]/input"))
				.sendKeys("Podnaslov");
		webDriver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div[2]/div[2]/div[3]/div[1]/div[2]/input"))
				.clear();
		webDriver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div[2]/div[2]/div[3]/div[1]/div[2]/input"))
				.sendKeys("400");

		webDriver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div[2]/div[2]/div[7]/div[2]/div")).clear();
		webDriver.findElement(By.xpath("/html/body/div[4]/div/div[1]/div[2]/div[2]/div[7]/div[2]/div"))
				.sendKeys("Ovo je dodatni opis mog artikla.");

		js = (JavascriptExecutor) webDriver;
		js.executeScript("window.scrollBy(0,200)", "");
		Thread.sleep(500);

		webDriver.findElement(By.id("dugmezavrsi")).click();
		Thread.sleep(4000);
	}
	
	
	void olxnewsTest() throws InterruptedException {
		webDriver.navigate().to(url);
		
		webDriver.findElement(By.id("ostalil")).click();
		webDriver.findElement(By.xpath("//*[@id=\"ko\"]/ul/li[7]/a")).click();
		
		Thread.sleep(2000);
		
		assertEquals("https://blog.olx.ba/", webDriver.getCurrentUrl());
	...
	void testSaveUser() throws InterruptedException{
		...
		webDriver.findElement(By.id("pratikorisnikap")).click();
		
		webDriver.findElement(By.xpath("//*[@id=\"mojpikgore\"]")).click();
		webDriver.findElement(By.xpath("/html/body/div[4]/div[2]/div[1]/div/ul[2]/li[3]/a")).click();
		
		String getSavedUser = webDriver.findElement(By.xpath("/html/body/div[4]/div/div[2]/div/div/div/div/a/div[3]/span")).getText();
		assertEquals("Masina_", getSavedUser);
